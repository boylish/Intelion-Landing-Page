...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className="bg-gray-900 pt-5 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            <a href="#" className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-200">
              Finolity
            </a>
            <p className="mt-4 text-gray-400 max-w-md">
              Empowering individuals and businesses to take control of their financial future with intelligent tools and insights.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Press Kit</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {currentYear} Finolity. All rights reserved.</p>
